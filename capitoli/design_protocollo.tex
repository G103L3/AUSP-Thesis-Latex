...
\noindent
La scelta della frequenza di campionamento deriva dal \textbf{teorema di Nyquist-Shannon} \citep[pp.448--449]{shannon1949}, secondo il quale un segnale può essere ricostruito senza ambiguità se la frequenza di campionamento $f_s$ è almeno doppia rispetto alla massima frequenza del segnale $f_{\max}$:
\[
f_s \geq 2 f_{\max}.
\]
...
\newpage
Una volta acquisito il blocco, viene calcolata la \textbf{trasformata veloce di Fourier (FFT)} \citep[pp.~297--301]{cooley1965fft} per 
analizzare lo spettro in frequenza. La complessità della FFT cresce come $N \log_2 N$, e per $N=512$ si hanno circa:
\[
512 \cdot \log_2(512) = 512 \cdot 9 = 4608
\]
operazioni complesse.  

Sul microcontrollore ESP32 dual-core operante a $240\,\text{MHz}$  questo si traduce in un tempo di elaborazione di circa $0.21\,\text{ms}$ 
per blocco, ovvero $\sim 0.415\,\mu\text{s}$ per campione. In termini di carico computazionale: $\sim 20$ moltiplicazioni, $\sim 29$ a
ddizioni/sottrazioni e un’operazione di radice quadrata per campione, pari a $\sim 99$ cicli di clock \citep[p.~30]{esp32techref}.  

\noindent
Questo significa che, a fronte di una finestra temporale di $10.7\,\text{ms}$, l’FFT viene calcolata in meno del $3\%$ 
del tempo disponibile, consentendo un’elaborazione in tempo reale anche senza multi-threading.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.50\textwidth]{immagini/fft_regression_check.png}
...
i falsi positivi, ogni frequenza candidata deve corrispondere a un \textbf{massimo locale}, ossia il \textbf{bin identificato}
 ...
 \begin{figure}[H]
    \centering
    \includegraphics[width=0.47\textwidth]{immagini/local_peak.png}
...
\begin{table}[H]
    ...
    3000 & (5) Bits: 000000 & & \\
    3400 & (6) Bits: 0000000 & & \\
    3800 & (7) Bits: 0000000 0000000 & & \\
    4200 & (8) Bits: 0000000 0000000 0000000 & & \\
    4600 & (9) <Libero> & & \\
    5000 & & & (10) Bits: 1 \\
    5400 & & & (11) Bits: 11 \\
    5800 & & & (12) Bits: 111 \\
    ...
    6600 & & & (14) Bits: 11111 \\
    7000 & & & (15) Bits: 111111 \\
    7400 & & & (16) Bits: 1111111 \\
    7800 & & & (17) Bits: 1111111 1111111 \\
    8200 & & Master Carrier & \\
    8600 & & Config Carrier & \\
    9000 & & Slave Carrier & \\
    \hline
